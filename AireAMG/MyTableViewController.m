...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    KMLViewerViewController *mapViewController = segue.destinationViewController;
    ...
    if ([segue.identifier isEqualToString:@"showDetail"]) {
        ...
        NSLog(@"%fso", mapItem.placemark.location.coordinate.longitude);
...
- (void)startSearch:(NSString *)searchString {
    ...
    newRegion.center.latitude = self.userCoordinate.latitude; //20.607420
    newRegion.center.longitude = self.userCoordinate.longitude; //-103.415333
